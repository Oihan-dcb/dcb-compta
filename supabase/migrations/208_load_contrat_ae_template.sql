-- Charge le template contrat de prestation AE (DCB + Lauïan).
...
<p>Le présent contrat est un contrat de prestation de services ayant pour objet la réalisation de prestations de <strong>préparation des logements</strong> et d'<strong>accueil des voyageurs</strong> dans des logements meublés gérés par le Client, dans le respect du cahier des charges et des procédures du Client (préparation/ménage et accueil), mis à disposition dans le Portail AE et mis à jour au besoin.</p>
...
<div class="art">Article 2 — Outils de mission (Portail AE et Tasks)</div>
<p>Les missions sont <strong>proposées, acceptées et suivies</strong> au moyen des outils mis à disposition par le Client : le <strong>Portail AE « DCB &amp; MOI »</strong> (ci-après « le Portail AE ») et <strong>« Tasks »</strong>, l'application spécialisée de Hospitable dédiée à l'attribution, à l'acceptation et au suivi des missions. Le Prestataire s'engage à consulter régulièrement ces outils, à y tenir son planning à jour et à y renseigner les comptes-rendus et photos de chaque mission. Les comptes-rendus, signalements d'incidents, prestations hors forfait et récapitulatifs de facturation transitent par ces outils. Toute mission est réputée n'avoir été ni proposée ni acceptée en dehors de ceux-ci.</p>

<div class="art">Article 3 — Rémunération et durée des missions</div>
<p>Le Prestataire est rémunéré au <strong>taux horaire de {{taux_horaire}} € de l'heure</strong>. Pour chaque mission, une <strong>durée de ménage</strong> est indiquée dans le Portail AE et dans l'application Tasks ; le montant de la mission correspond à ce taux horaire appliqué à la durée prévue. Le Prestataire est libre d'accepter ou non chaque mission en fonction de ces éléments (date, heure ou tranche horaire, lieu, durée, descriptif).</p>
<p><strong>Décompte du temps :</strong> le temps de travail est décompté à partir du moment où le Prestataire <strong>entre dans le logement</strong> et jusqu'au moment où il en <strong>sort</strong>, au moyen du <strong>pointage entrée/sortie réalisé dans le Portail AE « DCB &amp; MOI »</strong>. Les éventuels frais annexes nécessaires à l'exécution d'une prestation, validés au préalable, sont pris en charge en sus sur relevé de dépenses.</p>

<div class="art">Article 4 — Prestations hors forfait</div>
<p>Outre les missions standard, des <strong>prestations hors forfait</strong> (ménage de printemps, gestion du linge, attente prolongée, intervention exceptionnelle, petit dépannage, etc.) peuvent être réalisées. Elles doivent être <strong>préalablement validées par le Client</strong> et sont saisies par le Prestataire dans le module « prestations hors forfait » du Portail AE, au tarif convenu. Toute prestation hors forfait non validée au préalable ne pourra donner lieu à rémunération. Le détail des tâches comprises dans le forfait et de celles facturables en sus (hors forfait), ainsi que la partie redevable (propriétaire ou voyageur), figure à l'<strong>Annexe 1</strong> du présent contrat.</p>

<div class="art">Article 5 — Facturation, débours et paiement</div>
<p>La facturation est <strong>mensuelle</strong>. À la fin de chaque mois, le Prestataire établit sa ou ses factures récapitulant les missions et prestations hors forfait <strong>validées</strong> au cours du mois, <strong>à l'adresse du ou des propriétaires concernés</strong> (clients finaux de la prestation), le Portail AE mettant à sa disposition le récapitulatif correspondant.</p>
<p>Les prestations étant réalisées pour le compte des propriétaires, <strong>{{agence_nom}}</strong> — agissant dans le cadre des mandats de gestion qui la lient à ces derniers — <strong>avance le règlement de ces factures pour le compte des propriétaires</strong>, par virement bancaire sous <strong>{{delai_paiement}}</strong> à compter de leur réception, puis impute ces sommes sur les comptes des propriétaires concernés <strong>à titre de débours</strong>. Les éventuels frais annexes, validés au préalable, suivent le même régime de débours, sur relevé de dépenses.</p>
<p><strong>Prestations à la charge de l'agence :</strong> certaines prestations, lorsqu'elles sont à la charge directe de <strong>{{agence_nom}}</strong> et non d'un propriétaire (missions internes, interventions ponctuelles, prestations non rattachées à un logement géré…), sont <strong>facturées directement à {{agence_nom}}</strong> et réglées par elle par virement sous {{delai_paiement}}. Le Portail AE indique, pour chaque mission, le destinataire de la facturation (propriétaire en débours ou {{agence_nom}}). Le règlement effectué par {{agence_nom}} est libératoire. Le Prestataire fait son affaire personnelle de ses obligations sociales, fiscales et déclaratives.</p>
...
<!-- ════════ ANNEXE 1 — DÉTAIL FORFAIT / HORS FORFAIT ════════ -->
<div style="page-break-before:always">
  <div class="section-title" style="margin-top:0">Annexe 1 — Détail forfait / hors forfait</div>
  <p class="small">Répartition indicative des tâches comprises dans le temps de travail (forfait) et de celles facturables en sus (hors forfait), avec la partie redevable. « Entretien normal » : facturé au propriétaire ; dégradation du fait d'un client : facturée au client.</p>
  <table style="width:100%;border-collapse:collapse;font-size:8px;margin-top:6px">
    <thead>
      <tr style="background:#FBF6EC">
        <td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:700;color:#6B5840;width:15%">Tâche</td>
        <td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:700;color:#6B5840;width:25%">Compris dans le temps de travail</td>
        <td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:700;color:#6B5840;width:38%">Hors forfait (facturable)</td>
        <td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:700;color:#6B5840;width:22%">Qui facturer</td>
      </tr>
    </thead>
    <tbody>
      <tr><td colspan="4" style="border:1px solid #E8DCC8;padding:4px 6px;font-weight:700;background:#F3EEE2;text-align:center;color:#8a6d1f">Les plus fréquents</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Jardin</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Petit coup de balai</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Arracher les mauvaises herbes ; taille des plantes ; arrosage ; aspirateur ou coup de balai s'il y a beaucoup de sable</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire ; si client sale : client</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Terrasse</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Petit coup de balai ou aspirateur</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Karcher ; aspirateur ou coup de balai s'il y a beaucoup de sable</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire ; si client sale : client</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Vitres</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Passage microfibre sèche intérieur/extérieur si pas de pluie (entretien)</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Lessivage des vitres extérieures après pluie ou tempête (vitres poisseuses) ; nombreuses traces de doigts et gras</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire ; si client sale : client</td></tr>
      <tr><td colspan="4" style="border:1px solid #E8DCC8;padding:4px 6px;font-weight:700;background:#F3EEE2;text-align:center;color:#8a6d1f">Salle de bain</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Bonde</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Passage d'eau et de brosse, entretien quotidien et normal</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Bonde pleine de sable et/ou d'objets (les cheveux ne comptent pas)</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire ; si client sale : client</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Traitement des joints</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Passage microfibre ou produit spécial</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Traitement poussé avec brossage actif des joints</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Cuvette de toilette jaunie</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Passage microfibre et produit normal</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Traitement poussé avec brossage pour éliminer les traces tenaces</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire</td></tr>
      <tr><td colspan="4" style="border:1px solid #E8DCC8;padding:4px 6px;font-weight:700;background:#F3EEE2;text-align:center;color:#8a6d1f">Cuisine</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Entretien général des machines (four, hotte, lave-vaisselle, lave-linge, aspirateur, déshumidificateur…)</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Passage microfibre et vinaigre / savon noir / détartrage</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Nettoyage poussé du four et des plaques très sales ; filtres de hotte très gras + changement du filtre à charbon ; filtres du lave-vaisselle à la brosse et grande eau ; lave-linge : vidange et entretien des filtres ; nettoyage approfondi filtres et tuyaux ; déshumidificateur : filtres et aérations</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire ; si client sale : client</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Dessus de placards</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Façade de la cuisine à la microfibre vinaigrée</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Dessus de placards gras</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Vaisselle</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Vérification et passage rapide si un peu tachée ; ranger un peu de vaisselle propre (idéalement il ne devrait rien y avoir)</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Nettoyage de vaisselle sale ; vidage du lave-vaisselle s'il est très plein ; nettoyage de casseroles mal lavées par le client</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Si client sale : client</td></tr>
      <tr><td colspan="4" style="border:1px solid #E8DCC8;padding:4px 6px;font-weight:700;background:#F3EEE2;text-align:center;color:#8a6d1f">Général</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Lessivage des murs</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Une trace par-ci par-là à l'éponge magique</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Nombreuses traces dues à un client en particulier, ou une fois par mois</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire ; si client sale : client</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Rainures de volets et baies vitrées</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Coup d'aspirateur sur les rainures des baies vitrées</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Coup de microfibre sur volets et stores ; nettoyage approfondi à la brosse de la rainure</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Grilles d'aération</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Coup d'aspirateur si léger</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Démonter + entretenir + nettoyage à la brosse</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire</td></tr>
      <tr><td style="border:1px solid #E8DCC8;padding:5px 6px;font-weight:600">Détachage canapés / tapis</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Aspirateur pour les tapis</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Détachage avec produit à sec si tache nouvelle</td><td style="border:1px solid #E8DCC8;padding:5px 6px">Entretien normal : propriétaire ; si client sale : client</td></tr>
    </tbody>
  </table>
</div>

</body></html>
$aetpl$, '{"defaults": {"penalite_montant": "50", "preavis_resiliation": "trois semaines", "non_solicit_jours": "365", "delai_paiement": "30 jours", "incident_delai": "24 heures", "taux_horaire": "25"}}'::jsonb, true),
