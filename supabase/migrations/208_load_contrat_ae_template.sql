...
<p>Les missions sont <strong>proposées, acceptées et suivies</strong> au moyen des outils mis à disposition par le Client : le <strong>Portail AE {{agence_nom}}</strong> et <strong>« Tasks »</strong>, l'application spécialisée de Hospitable dédiée à l'attribution, à l'acceptation et au suivi des missions. Le Prestataire s'engage à consulter régulièrement ces outils, à y tenir son planning à jour et à y renseigner les comptes-rendus et photos de chaque mission. Les comptes-rendus, signalements d'incidents, prestations hors forfait et récapitulatifs de facturation transitent par ces outils. Toute mission est réputée n'avoir été ni proposée ni acceptée en dehors de ceux-ci.</p>
...
<p><strong>Décompte du temps :</strong> le temps de travail est décompté à partir du moment où le Prestataire <strong>entre dans le logement</strong> et jusqu'au moment où il en <strong>sort</strong>. Les éventuels frais annexes nécessaires à l'exécution d'une prestation, validés au préalable, sont pris en charge en sus sur relevé de dépenses.</p>
