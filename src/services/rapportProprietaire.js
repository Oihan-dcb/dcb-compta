...
<div class="container">
  ...
  <div class="section-synthese" style="position:relative;height:230px;display:block;-webkit-print-color-adjust:exact !important;print-color-adjust:exact !important;">
    ...
    <div style="position:absolute;top:0;left:0;right:0;bottom:150px;display:flex;flex-direction:column;align-items:center;justify-content:center;">
    ...
    <div style="position:absolute;bottom:68px;left:0;right:0;text-align:center;">
      <img src="${logoSrc}"
        style="height:120px;display:block;margin:0 auto;-webkit-print-color-adjust:exact;print-color-adjust:exact;" onerror="this.style.display='none'"/>
    </div>
