...
function ModalFiche({ proprio, onClose, onSaved }) {
  ...
  // deux change).
  //
  // Refonte 2026-09-10 : remplace les 7 presets historiques (vitrine/
  // communication/essentiel/suivi/transparent/investisseur/complet), qui
  // mélangeaient deux axes dans un seul menu (vitrine avait voyageur_complet
  // et la maintenance visibles, transparent/investisseur non — ce n'était pas
  // une échelle) et comptaient 3 presets à 0 utilisateur réel. Nouvelle
  // échelle : 6 classes en ESCALADE STRICTE (chaque classe = sur-ensemble de
  // la précédente), + `voyageur_complet`/`voyageur_contact` hors échelle
  // (false partout) et `montant_vir_reel` réservé à `personnalise`. Détail
  // complet et rationale : dcb-portail-owner/shared/profilPresets.js.
  const PROFILS = {
    vitrine:      { label: 'Vitrine',    desc: 'Aucun chiffre — planning, maintenance, documents du bien et messagerie' },
    reversement:  { label: 'Reversement', desc: 'Vitrine + montant et date du virement, sans décomposition' },
    suivi:        { label: 'Suivi',      desc: 'Reversement + commission, prestations, taxe de séjour, achats et occupation (hors détail ménage)' },
    detaille:     { label: 'Détaillé',   desc: 'Suivi + décomposition ménage voyageurs, revenu brut/net complet, commission par séjour, devis et factures maintenance' },
    rendement:    { label: 'Rendement',  desc: 'Détaillé + performance (RevPAR, N-1, projection) et validation des devis' },
    integral:     { label: 'Intégral',   desc: 'Rendement + preuve bancaire interne du virement (rapprochement)' },
    personnalise: { label: 'Personnalisé', desc: 'Config champ par champ' },
  }

  // Copie exacte de dcb-portail-owner/shared/profilPresets.js (aplatie —
  // le fichier source chaîne ces mêmes valeurs par spread pour garantir la
  // monotonicité de l'escalade ; la copie ici reste littérale à plat).
  const PROFIL_PRESETS = {
    vitrine:     { revenus_bruts: false, hebergement_net: false, commission_base: false, commission_detail: false, menage: false, prestations: false, frais_divers: false, achats_proprio: false, taxe_sejour: false, statut_virement: false, date_virement: false, rapprochement: false, montant_vir_reel: false, taux_occupation: false, nuits_vendues: false, prix_moyen: false, revpar: false, comparaison_n1: false, projection_revenus: false, plateforme: true, voyageur_complet: false, voyageur_contact: false, note_voyageur: true, menage_date: true, planning_reservations: true, planning_blocages: true, planning_motif_blocage: false, planning_sejours_proprio: true, planning_menage_date: true, planning_menage_heure: false, demande_blocage_dates: true, maintenance_actif: true, maintenance_devis: false, maintenance_validation: false, maintenance_statut: true, maintenance_factures: false, maintenance_tech_issues: true, maintenance_entretiens: true, documents_mandat: true, documents_factures: false, documents_releves: false, documents_diagnostics: true, documents_contrats: false, documents_attestations: true, documents_inventaire: true, documents_photos: true, demandes_actives: true, messagerie: true, types_demandes: ['blocage_dates','intervention','probleme','question','document','autre'], notifications_email: true, loc_longue_duree: true },
    reversement: { revenus_bruts: false, hebergement_net: false, commission_base: false, commission_detail: false, menage: false, prestations: false, frais_divers: false, achats_proprio: false, taxe_sejour: false, statut_virement: true, date_virement: true, rapprochement: false, montant_vir_reel: false, taux_occupation: false, nuits_vendues: false, prix_moyen: false, revpar: false, comparaison_n1: false, projection_revenus: false, plateforme: true, voyageur_complet: false, voyageur_contact: false, note_voyageur: true, menage_date: true, planning_reservations: true, planning_blocages: true, planning_motif_blocage: false, planning_sejours_proprio: true, planning_menage_date: true, planning_menage_heure: false, demande_blocage_dates: true, maintenance_actif: true, maintenance_devis: false, maintenance_validation: false, maintenance_statut: true, maintenance_factures: false, maintenance_tech_issues: true, maintenance_entretiens: true, documents_mandat: true, documents_factures: false, documents_releves: true, documents_diagnostics: true, documents_contrats: false, documents_attestations: true, documents_inventaire: true, documents_photos: true, demandes_actives: true, messagerie: true, types_demandes: ['blocage_dates','intervention','probleme','question','document','autre'], notifications_email: true, loc_longue_duree: true },
    suivi:       { revenus_bruts: false, hebergement_net: false, commission_base: true, commission_detail: false, menage: false, prestations: true, frais_divers: true, achats_proprio: true, taxe_sejour: true, statut_virement: true, date_virement: true, rapprochement: false, montant_vir_reel: false, taux_occupation: true, nuits_vendues: false, prix_moyen: false, revpar: false, comparaison_n1: false, projection_revenus: false, plateforme: true, voyageur_complet: false, voyageur_contact: false, note_voyageur: true, menage_date: true, planning_reservations: true, planning_blocages: true, planning_motif_blocage: false, planning_sejours_proprio: true, planning_menage_date: true, planning_menage_heure: false, demande_blocage_dates: true, maintenance_actif: true, maintenance_devis: false, maintenance_validation: false, maintenance_statut: true, maintenance_factures: false, maintenance_tech_issues: true, maintenance_entretiens: true, documents_mandat: true, documents_factures: true, documents_releves: true, documents_diagnostics: true, documents_contrats: false, documents_attestations: true, documents_inventaire: true, documents_photos: true, demandes_actives: true, messagerie: true, types_demandes: ['blocage_dates','intervention','probleme','question','document','autre','estimation'], notifications_email: true, loc_longue_duree: true },
    detaille:    { revenus_bruts: true, hebergement_net: true, commission_base: true, commission_detail: true, menage: true, prestations: true, frais_divers: true, achats_proprio: true, taxe_sejour: true, statut_virement: true, date_virement: true, rapprochement: false, montant_vir_reel: false, taux_occupation: true, nuits_vendues: true, prix_moyen: true, revpar: false, comparaison_n1: false, projection_revenus: false, plateforme: true, voyageur_complet: false, voyageur_contact: false, note_voyageur: true, menage_date: true, planning_reservations: true, planning_blocages: true, planning_motif_blocage: false, planning_sejours_proprio: true, planning_menage_date: true, planning_menage_heure: false, demande_blocage_dates: true, maintenance_actif: true, maintenance_devis: true, maintenance_validation: false, maintenance_statut: true, maintenance_factures: true, maintenance_tech_issues: true, maintenance_entretiens: true, documents_mandat: true, documents_factures: true, documents_releves: true, documents_diagnostics: true, documents_contrats: false, documents_attestations: true, documents_inventaire: true, documents_photos: true, demandes_actives: true, messagerie: true, types_demandes: ['blocage_dates','intervention','probleme','question','document','autre','estimation'], notifications_email: true, loc_longue_duree: true },
    rendement:   { revenus_bruts: true, hebergement_net: true, commission_base: true, commission_detail: true, menage: true, prestations: true, frais_divers: true, achats_proprio: true, taxe_sejour: true, statut_virement: true, date_virement: true, rapprochement: false, montant_vir_reel: false, taux_occupation: true, nuits_vendues: true, prix_moyen: true, revpar: true, comparaison_n1: true, projection_revenus: true, plateforme: true, voyageur_complet: false, voyageur_contact: false, note_voyageur: true, menage_date: true, planning_reservations: true, planning_blocages: true, planning_motif_blocage: true, planning_sejours_proprio: true, planning_menage_date: true, planning_menage_heure: true, demande_blocage_dates: true, maintenance_actif: true, maintenance_devis: true, maintenance_validation: true, maintenance_statut: true, maintenance_factures: true, maintenance_tech_issues: true, maintenance_entretiens: true, documents_mandat: true, documents_factures: true, documents_releves: true, documents_diagnostics: true, documents_contrats: true, documents_attestations: true, documents_inventaire: true, documents_photos: true, demandes_actives: true, messagerie: true, types_demandes: ['blocage_dates','intervention','probleme','question','document','autre','estimation'], notifications_email: true, loc_longue_duree: true },
    integral:    { revenus_bruts: true, hebergement_net: true, commission_base: true, commission_detail: true, menage: true, prestations: true, frais_divers: true, achats_proprio: true, taxe_sejour: true, statut_virement: true, date_virement: true, rapprochement: true, montant_vir_reel: false, taux_occupation: true, nuits_vendues: true, prix_moyen: true, revpar: true, comparaison_n1: true, projection_revenus: true, plateforme: true, voyageur_complet: false, voyageur_contact: false, note_voyageur: true, menage_date: true, planning_reservations: true, planning_blocages: true, planning_motif_blocage: true, planning_sejours_proprio: true, planning_menage_date: true, planning_menage_heure: true, demande_blocage_dates: true, maintenance_actif: true, maintenance_devis: true, maintenance_validation: true, maintenance_statut: true, maintenance_factures: true, maintenance_tech_issues: true, maintenance_entretiens: true, documents_mandat: true, documents_factures: true, documents_releves: true, documents_diagnostics: true, documents_contrats: true, documents_attestations: true, documents_inventaire: true, documents_photos: true, demandes_actives: true, messagerie: true, types_demandes: ['blocage_dates','intervention','probleme','question','document','autre','estimation'], notifications_email: true, loc_longue_duree: true },
  }
