...
function PlatformLogo({ platform, ownerStay, size = 18 }) {
  ...
  return (
    <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5 }}>
      <img src="/logo-dcb.png" width={size} height={size} style={{ display: 'block', objectFit: 'contain', flexShrink: 0 }} alt="DCB" />
