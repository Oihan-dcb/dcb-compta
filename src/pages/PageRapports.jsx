                      ...
                      {data.resas.map((r, i) => {
                        ...
                        return (
                          <tr key={r.id} style={{ background: i % 2 === 0 ? '#FDFAF4' : '#F7F3EC' }}>
                            ...
                            {(colsConfig.brut      ?? false) && <td style={{ padding: '6px 8px', textAlign: 'right', color: '#4A3728', whiteSpace: 'nowrap', fontSize: '0.75em' }}>{fmt(r.fin_accommodation || 0)} | MEN={fmt(v.MEN?.montant_ht || 0)} | TOTAL={fmt((r.fin_accommodation || 0) + (v.MEN?.montant_ht || 0))}</td>}
