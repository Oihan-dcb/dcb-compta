    ...
    <div className='page-container'>
      <div className='page-header'>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          {/* Import CSV manuel masqué uniquement pour DCB : ce compte (CAISSE EPARGNE LOCATION
              SAISONNIERE) est alimenté automatiquement par api/pennylane-mouvement-sync (cron
              nightly 3h50) depuis le 07/07/2026. Réactiver ferait doublonner (pennylaneDedup.js).
              Lauian/Bordeaux n'ont pas encore de token Pennylane (tâche #5) : import CSV conservé. */}
          {AGENCE === 'dcb' ? (
